...
This package comes with a template library with data from Glacier National Park. Both the Promtheus and FireSTARR add-on packages are required if you would like to run all the included scenarios.