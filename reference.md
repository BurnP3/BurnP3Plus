...
**BurnP3+** has a *library*, and multiple *project*- and, *scenario*-scoped *datasheets*. The associated **BurnP3+** fire growth model packages (**BurnP3+Cell2Fire**, **BurnP3+Prometheus**, and **BurnP3+FireSTARR**) also contain several *project* and *scenario*-scoped *datasheets*. Within this Reference guide, you will find details on each field within the **BurnP3+**, **BurnP3+Cell2Fire**, **BurnP3+Prometheus**, and **BurnP3+FireSTARR** datasheets. For details on *datasheets* that are package-agnostic and specific to SyncroSim, see the <a href="https://docs.syncrosim.com/reference/ds_overview.html" target="_blank">SyncroSim System Datasheets Overview</a>.
